...
export default async function AsdosPrintPage({ searchParams }: { searchParams: Promise<{ month?: string; start?: string; end?: string }> }) {
  ...
  return (
    <main className="print-page">
      <div className="screen-actions"><button id="print-asdos-button" type="button" className="print-button">🖨 Print Rekap Asdos</button><a href="/asdos" className="back-link">← Kembali</a></div>
      ...
      <script dangerouslySetInnerHTML={{ __html: `document.addEventListener("click", function(event){ const target = event.target; if (target && target.id === "print-asdos-button") { window.print(); } });` }} />
